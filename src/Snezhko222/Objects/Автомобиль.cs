...
namespace IIS.Snezhko222
{
    ...
    public class Автомобиль : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Snezhko222.Клиенты.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View АвтомобильE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АвтомобильE", typeof(IIS.Snezhko222.Автомобиль));
                }
            }
        }
    }
    ...
    public class DetailArrayOfАвтомобиль : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Snezhko222.DetailArrayOfАвтомобиль members)

        // *** End programmer edit section *** (IIS.Snezhko222.DetailArrayOfАвтомобиль members)
        ...
        /// </summary>
        public DetailArrayOfАвтомобиль(IIS.Snezhko222.Клиенты fКлиенты) : 
                base(typeof(Автомобиль), ((ICSSoft.STORMNET.DataObject)(fКлиенты)))
        {
        }
        
        public IIS.Snezhko222.Автомобиль this[int index]
        {
            get
            {
                return ((IIS.Snezhko222.Автомобиль)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Snezhko222.Автомобиль dataobject)
        {
