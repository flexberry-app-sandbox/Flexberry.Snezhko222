...
namespace IIS.Snezhko222
{
    ...
    public class Услуга : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Snezhko222.DetailArrayOfСоставУслуги fСоставУслуги;
        ...
        public virtual IIS.Snezhko222.DetailArrayOfСоставУслуги СоставУслуги
        {
            get
            {
                ...
                {
                    this.fСоставУслуги = new IIS.Snezhko222.DetailArrayOfСоставУслуги(this);
                }
                IIS.Snezhko222.DetailArrayOfСоставУслуги result = this.fСоставУслуги;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УслугаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаE", typeof(IIS.Snezhko222.Услуга));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугаL", typeof(IIS.Snezhko222.Услуга));
                }
            }
        }
    }
